...
module.exports = function Collection(db, state) {
  ...
  var iface = {
    ...
    __setPkFactory: function (pkFactory) { pk = pkFactory || ObjectId },
    ...
    deleteOne: function (filter, options, callback) {
      ...
      asyncish(function () {
        ...
        callback(null, { result: { n: docs.length, ok: deletionIndex !== -1 ? 1 : 0 }, deletedCount: docs.length, connection: db });
      });
      if (typeof callback !== 'function') {
        return new Promise(function (resolve, reject) {
          callback = function (e, r) { e ? reject(e) : resolve(r) };
